...
// lib/screens/five_day_forecast_screen.dart
import 'package:flutter/material.dart';
import 'dart:math' as math;
import '../models/location_model.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: Icon(
            Icons.arrow_back,
            color: Colors.black87, // LIGHT: ĐEN, DARK: TRẮNG
            size: 28,
          ),
          onPressed: () => Navigator.pop(context),
        ),
        title: Text(
          ...
          style: TextStyle(
            color: Colors.black87, // SỬA CHÍNH: CHỮ HIỆN RÕ CẢ 2 MODE
            fontSize: 28,
